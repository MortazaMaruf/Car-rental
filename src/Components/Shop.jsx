...
const Shop = () => {
  const shopCardInfo = [
    {img:img1,title:"Cabrio Rent",category:"Expensive",cost:"210.00"},
    {img:img2,title:"Mercedes 4×4",category:"Expensive",cost:"220.00"},
        {img:img3,title:"Porche Macan",category:"Expensive",cost:"210.00"},
        {img:img4,title:"Vinttage Book",category:"Expensive",cost:"70.00"},
        {img:img5,title:"Rolss Royce",category:"Expensive",cost:"170.00"},
        {img:img6,title:"Mercedes Benz",category:"Expensive",cost:"180.00"},
    ]
  return (
